...
const HeroSection = () => {
  return (
    <div className="h-full relative">
      ...
      <div
        className="h-screen flex justify-center bg-center bg-cover w-full relative"
        style={{
          backgroundImage: "url('logo/image/UPN_VETERAN_JAKARTA.webp')",
        }}
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/70 to-white w-full h-full">
          ...
          <div className="absolute inset-0 flex justify-center items-center h-full">
            <div className="flex flex-col items-center text-center text-white justify-center">
              <p className="text-xl md:text-4xl font-semibold animate__animated animate__zoomIn animate__slower animate__delay-1s">
              ...
              <p className="text-2xl md:text-4xl font-semibold pb-3 animate__animated animate__zoomIn animate__slower animate__delay-2s">
