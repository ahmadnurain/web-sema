...
const Bph = () => {
  ...
  return (
    <div>
      ...
      {/* Members Section */}
      <div
        className="bg-cover w-full overflow-y-hidden"
        style={{
          backgroundImage: "url(/Background/background-bemu.html)",
        }}
      >
        <div className="bg-white/85 flex justify-center">
          <div className="w-full flex flex-col justify-center items-center">
            ...
            <div className="pt-10">
              <div className=" flex flex-wrap justify-center text-center text-lg md:text-xl font-normal text-red-800 pb-8 px-4 md:pb-12" data-aos="fade-up" data-aos-duration="2000">
                {data.anggota.map((orang) => (
                  <div key={orang.id} className="w-1/2 md:w-1/3 lg:w-1/4 py-2 box-border">
                    <img className="object-cover z-10" src={`/departments/${orang.image}`} alt={orang.name} />
                    <p className="flex flex-col justify-center items-center bg-red-800 border-2 border-yellow-600 text-white text-sm mx-3 px-1 py-1 rounded-lg">
                      {orang.name}
                      <hr className="w-28 md:w-52 justify-center border-warna-kuning border-b-1" data-aos="fade-down" data-aos-duration="2000" />
                    ...
                    <p className="font-semibold hover:text-yellow-600">
                      <a data-tooltip-target={`tooltip-${orang.name.replace(/\s+/g, "-")}`} href={`https://www.instagram.com/${orang.instagram}`}>
                        @{orang.instagram}
                      </a>
                    </p>
                  </div>
